...
**Data Collection:**
- [x] Bernie Sanders: Complete - 31,612 transactions, 11,419 unique donors, 2.9% top-10 concentration
- [ ] Nancy Pelosi: In progress - 4,465/19,659 transactions (23% done)
  - Auto-running every 2 minutes via cron
  - Estimated completion: ~60 minutes (30 runs × 2 min)
- [ ] Validate free-tier results match prototype (Bernie: 13,102 donors vs 11,419 - investigate difference)

**Analysis:**
- [ ] Once Pelosi complete, compare concentration metrics
- [ ] Document: Both ~41% itemized but Bernie has 4.4× more donors, 2.7× less concentration
- [ ] Prove: Current tier calc treats them identically (Issue #19 bug)

**Decision Point (After Test Complete):**
- [ ] Option A: Scale to all 535 members (45 days at 10/day pace)
- [ ] Option B: Define concentration penalty formula first, integrate into tier calc
- [ ] Option C: Fix 132 members with missing `largeDonorDonations` data first
- [ ] Option D: Something else (ask user)

### Known Issues

**Issue #19 - Tier Calculation Broken:**
- Status: ⏸️ Blocked on completing test case
- Blocker: Need Pelosi data to prove bug with hard evidence

**Issue #20 - Donor Concentration Analysis:**
- Status: ⚠️ Architecture complete, scaling blocked
- Blocker: Test case not finished yet
