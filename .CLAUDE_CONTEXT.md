...
- [ ] Bernie Sanders: Collecting - 8,000/37,612 transactions (21% done)
...
- [ ] Nancy Pelosi: Collecting - ~9,500/19,600 transactions (48% done)
  - Collecting with Gini coefficient
  - Auto-running every 2 minutes via cron
...
**Decision Point (After Test Complete):**
- [ ] Scale to all 535 members? (45 days at 10/day pace, 720 writes/day limit)
- [ ] Fix 132 members with missing `largeDonorDonations` data first?
- [ ] Something else?
